...
entity Conv2D_HW_control_s_axi is
generic (
...
end entity Conv2D_HW_control_s_axi;
...
architecture behave of Conv2D_HW_control_s_axi is
    ...
    constant ADDR_FILTERS_DATA_0     : INTEGER := 16#20#;
    constant ADDR_FILTERS_CTRL       : INTEGER := 16#24#;
    constant ADDR_NUMCHANNELS_DATA_0 : INTEGER := 16#28#;
    constant ADDR_NUMCHANNELS_CTRL   : INTEGER := 16#2c#;
    constant ADDR_NUMFILTERS_DATA_0  : INTEGER := 16#30#;
    constant ADDR_NUMFILTERS_CTRL    : INTEGER := 16#34#;
    constant ADDR_INPUTWIDTH_DATA_0  : INTEGER := 16#38#;
    constant ADDR_INPUTWIDTH_CTRL    : INTEGER := 16#3c#;
    constant ADDR_INPUTHEIGHT_DATA_0 : INTEGER := 16#40#;
    constant ADDR_INPUTHEIGHT_CTRL   : INTEGER := 16#44#;
    constant ADDR_CONVWIDTH_DATA_0   : INTEGER := 16#48#;
    constant ADDR_CONVWIDTH_CTRL     : INTEGER := 16#4c#;
    constant ADDR_CONVHEIGHT_DATA_0  : INTEGER := 16#50#;
    constant ADDR_CONVHEIGHT_CTRL    : INTEGER := 16#54#;
    ...
    signal int_filters         : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_INPUTWIDTH_DATA_0 =>
                        rdata_data <= RESIZE(int_inputWidth(31 downto 0), 32);
                    when ADDR_INPUTHEIGHT_DATA_0 =>
                        rdata_data <= RESIZE(int_inputHeight(31 downto 0), 32);
                    when ADDR_CONVWIDTH_DATA_0 =>
                        rdata_data <= RESIZE(int_convWidth(31 downto 0), 32);
...
-- ----------------------- Register logic ----------------
    ...
    inputHeight          <= STD_LOGIC_VECTOR(int_inputHeight);
    convWidth            <= STD_LOGIC_VECTOR(int_convWidth);
    convHeight           <= STD_LOGIC_VECTOR(int_convHeight);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_NUMCHANNELS_DATA_0) then
                    int_numChannels(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_numChannels(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_INPUTWIDTH_DATA_0) then
                    int_inputWidth(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_inputWidth(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_INPUTHEIGHT_DATA_0) then
                    int_inputHeight(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_inputHeight(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CONVWIDTH_DATA_0) then
                    int_convWidth(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_convWidth(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CONVHEIGHT_DATA_0) then
                    int_convHeight(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_convHeight(31 downto 0));
                end if;
            end if;
        end if;
    end process;
